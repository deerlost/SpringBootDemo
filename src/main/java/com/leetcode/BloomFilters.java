...
public class BloomFilters {
    ...
    public void add(String key) {
        ...
        array[first & arraySize - 1] = 1;
        array[second & arraySize - 1] = 1;
        array[third & arraySize - 1] = 1;
    }
    ...
    public boolean check(String key) {
        ...
        int second = hashcode_2(key);
        int third = hashcode_3(key);
        int firstIndex = array[first & arraySize - 1];
        if (firstIndex == 0) {
            return false;
        }
        int secondIndex = array[second & arraySize - 1];
        if (secondIndex == 0) {
            return false;
        }
        int thirdIndex = array[third & arraySize - 1];
        if (thirdIndex == 0) {
            return false;
        }
        return true;
